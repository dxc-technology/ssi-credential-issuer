...
Credential Issuer is an open project, and community contributions are essential for
keeping it great.
...
* Submit a ticket for your issue, assuming one does not already exist.
  * Tickets are filed on the GitHub project:
    https://github.com/dxc-technology/ssi-credential-issuer/issues
...
We really want Credential Issuer to be simple to contribute to, and to ensure that you can
...
Until a stable version of Credential Issuer is shipped, there is only one branch:
...
Credential Issuer is an open project: any contributor can become a committer.  Being a
committer comes with great responsibility: your decisions directly shape the
community, and the effectiveness, of the Credential Issuer project.  You will probably
